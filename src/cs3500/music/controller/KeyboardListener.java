...
public class KeyboardListener implements KeyListener {
  ...
  public void addKeyTypedListener(Character c, Runnable runnable) {
    this.keyTypedMap.put(c, runnable);
  }

  public void addKeyPressedListener(Integer i, Runnable runnable) {
    this.keyPressedMap.put(i, runnable);
  }

  public void addKeyReleasedListener(Integer i, Runnable runnable) {
    this.keyReleasedMap.put(i, runnable);
  }
